...
By day: PHP, Symfony, TypeScript, React. By night: Go, Redis, RabbitMQ, and figuring out why my channels deadlock.
What I believe:

    Understand the layer below the one you work in
    If you can't test it without the database, the architecture is wrong
    Frameworks are fine until they hide the problem

Currently learning: Go concurrency, clean architecture, Docker, systemd, Designing Data-Intensive Applications
